...
public class Career {
	...
	private ArrayList<Eng_Grade> eng_grade;
	...
	public ArrayList<Exchange> getExchange() {return exchange;}
	public ArrayList<Intern> getIntern() {return intern;}
	public ArrayList<Eng_Grade> getEng_grade() {return eng_grade;}
	...
	public void setExchange(ArrayList<Exchange> exchange) {this.exchange = exchange;}
	public void setIntern(ArrayList<Intern> intern) {this.intern = intern;}
	public void setEng_grade(ArrayList<Eng_Grade> eng_grade) {this.eng_grade = eng_grade;}
